...
public class EventCodecHandler implements GatewayOperationHandler {
    ...
    static {
        ...
        EVENT_DECODERS.put(EventType.MESSAGE_REACTION_REMOVE_ALL,
                new MessageReactionsRemovedDecoder());
        EVENT_HANDLERS.put(EventType.MESSAGE_REACTION_REMOVE_ALL,
                new MessageReactionsRemovedHandler());
        ...
        EVENT_HANDLERS.put(EventType.AUTO_MODERATION_RULE_CREATE,
                new AutoModerationRuleCreateHandler());
        EVENT_HANDLERS.put(EventType.AUTO_MODERATION_RULE_UPDATE,
                new AutoModerationRuleUpdateHandler());
        EVENT_HANDLERS.put(EventType.AUTO_MODERATION_RULE_DELETE,
                new AutoModerationRuleDeleteHandler());
        EVENT_HANDLERS.put(EventType.AUTO_MODERATION_ACTION_EXECUTION,
                new AutoModerationRuleDeleteHandler());
        ...
        EVENT_HANDLERS.put(EventType.GUILD_SCHEDULED_EVENT_CREATE,
                new ScheduledEventCreateHandler());
        EVENT_HANDLERS.put(EventType.GUILD_SCHEDULED_EVENT_UPDATE,
                new ScheduledEventUpdateHandler());
        EVENT_HANDLERS.put(EventType.GUILD_SCHEDULED_EVENT_DELETE,
                new ScheduledEventDeleteHandler());
        ...
        EVENT_HANDLERS.put(EventType.GUILD_SCHEDULED_EVENT_USER_ADD,
                new ScheduledEventUserAddHandler());
        EVENT_HANDLERS.put(EventType.GUILD_SCHEDULED_EVENT_USER_REMOVE,
                new ScheduledEventUserRemoveHandler());
