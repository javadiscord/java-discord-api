...
public record Thread(@JsonProperty("type") int type,
        ...
        @JsonProperty("parent_id") String parentId, @JsonProperty("owner_id") String ownerId,
        @JsonProperty("newly_created") boolean newlyCreated, @JsonProperty("name") String name,
        @JsonProperty("message_count") int messageCount,
        @JsonProperty("member_count") int memberCount,
        @JsonProperty("last_message_id") String lastMessageId, @JsonProperty("id") String id,
        @JsonProperty("guild_id") String guildId, @JsonProperty("flags") int flags) {}
