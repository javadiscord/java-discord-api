...
public record GetScheduledEventUsersRequest(long guildId, long scheduledEventId,
        Optional<Integer> limit, Optional<Boolean> withMember, Optional<Long> before, // both of
                                                                                      // these can
                                                                                      // be provided
                                                                                      // but before
                                                                                      // will be
                                                                                      // favored
        Optional<Long> after) implements DiscordRequest {
