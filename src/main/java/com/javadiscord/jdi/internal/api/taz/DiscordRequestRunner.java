...
public class DiscordRequestRunner implements Runnable {
    ...
    public DiscordRequestRunner(String botToken) {
    ...
    public DiscordResponseFuture queue(DiscordRequestBuilder discordRequestBuilder) {
