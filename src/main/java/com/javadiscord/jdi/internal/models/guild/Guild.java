...
public record Guild(
        ...
        @JsonProperty("premium_subscription_count") Integer premiumSubscriptionCount,
        @JsonProperty("preferred_locale") String preferredLocale,
        @JsonProperty("public_updates_channel_id") long publicUpdatesChannelId,
        @JsonProperty("max_video_channel_users") Integer maxVideoChannelUsers,
        @JsonProperty("max_stage_video_channel_users") Integer maxStageVideoChannelUsers,
        @JsonProperty("approximate_member_count") Integer approximateMemberCount,
        @JsonProperty("approximate_presence_count") Integer approximatePresenceCount,
