...
public record Connection(@JsonProperty("id") String id, @JsonProperty("name") String name,
        @JsonProperty("type") String type, @JsonProperty("revoked") boolean revoked,
        @JsonProperty("integrations") Integration integrations,
        @JsonProperty("verified") boolean verified, @JsonProperty("friend_sync") boolean friendSync,
