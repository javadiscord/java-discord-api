...
public record AutoModerationRuleObject(@JsonProperty("id") long id,
        @JsonProperty("guild_id") long guildId, @JsonProperty("name") String name,
        @JsonProperty("creator_id") long creatorId, @JsonProperty("event_type") int eventType,
