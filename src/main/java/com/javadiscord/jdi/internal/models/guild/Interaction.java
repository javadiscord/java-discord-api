...
public record Interaction(@JsonProperty("id") long id,
        @JsonProperty("application_id") long applicationId, @JsonProperty("type") String type,
        @JsonProperty("data") InteractionData data, @JsonProperty("guild_id") long guildId,
        @JsonProperty("channel") Channel channel, @JsonProperty("channel_id") long channelId,
        @JsonProperty("member") Member member, @JsonProperty("user") User user,
        @JsonProperty("token") String token, @JsonProperty("version") int version,
        @JsonProperty("message") Message message,
        @JsonProperty("app_permissions") String appPermissions,
        @JsonProperty("locale") String locale, @JsonProperty("guild_locale") String guildLocale,
