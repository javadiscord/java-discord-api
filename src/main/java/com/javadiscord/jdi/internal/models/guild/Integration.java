...
public record Integration(@JsonProperty("id") long id, @JsonProperty("name") String name,
        @JsonProperty("type") String type, @JsonProperty("enabled") boolean enabled,
        @JsonProperty("syncing") boolean syncing, @JsonProperty("role_id") long roleId,
        @JsonProperty("enable_emoticons") boolean enableEmoticons,
        @JsonProperty("expire_behaviour") int expireBehaviour,
        @JsonProperty("expire_grace_period") int expireGracePeriod, @JsonProperty("user") User user,
